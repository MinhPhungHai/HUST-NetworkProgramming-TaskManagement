...
enum MessageType {
    ...
    MSG_CHANGE_PASSWORD_REQUEST = 11,
    MSG_CHANGE_PASSWORD_RESPONSE = 12,
    MSG_RESET_PASSWORD_REQUEST = 13,
    MSG_RESET_PASSWORD_RESPONSE = 14,
    MSG_RESET_PASSWORD_CONFIRM_REQUEST = 15,
    MSG_RESET_PASSWORD_CONFIRM_RESPONSE = 16,
    ...
    MSG_REMOVE_PROJECT_MEMBER_REQUEST = 32,
    MSG_REMOVE_PROJECT_MEMBER_RESPONSE = 33,
    ...
    MSG_DOWNLOAD_FILE_REQUEST = 84,
    MSG_DOWNLOAD_FILE_RESPONSE = 85,
    MSG_DELETE_FILE_REQUEST = 86,
    MSG_DELETE_FILE_RESPONSE = 87,
...
inline const char* getMessageTypeName(MessageType type) {
    switch(type) {
        ...
        case MSG_LOGOUT_REQUEST: return "LOGOUT_REQUEST";
        case MSG_LOGOUT_RESPONSE: return "LOGOUT_RESPONSE";
        case MSG_CHANGE_PASSWORD_REQUEST: return "CHANGE_PASSWORD_REQUEST";
        case MSG_CHANGE_PASSWORD_RESPONSE: return "CHANGE_PASSWORD_RESPONSE";
        case MSG_RESET_PASSWORD_REQUEST: return "RESET_PASSWORD_REQUEST";
        case MSG_RESET_PASSWORD_RESPONSE: return "RESET_PASSWORD_RESPONSE";
        case MSG_RESET_PASSWORD_CONFIRM_REQUEST: return "RESET_PASSWORD_CONFIRM_REQUEST";
        case MSG_RESET_PASSWORD_CONFIRM_RESPONSE: return "RESET_PASSWORD_CONFIRM_RESPONSE";
        ...
        case MSG_INVITE_TO_PROJECT_REQUEST: return "INVITE_TO_PROJECT_REQUEST";
        case MSG_INVITE_TO_PROJECT_RESPONSE: return "INVITE_TO_PROJECT_RESPONSE";
        case MSG_REMOVE_PROJECT_MEMBER_REQUEST: return "REMOVE_PROJECT_MEMBER_REQUEST";
        case MSG_REMOVE_PROJECT_MEMBER_RESPONSE: return "REMOVE_PROJECT_MEMBER_RESPONSE";
